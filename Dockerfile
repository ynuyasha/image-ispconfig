...
# --- 20 Install ISPConfig 3.1
RUN cd /tmp && cd . && wget http://www.ispconfig.org/downloads/ISPConfig-3.1.tar.gz
RUN cd /tmp && tar xfz ISPConfig-3.1.tar.gz
RUN service mysql restart
